#ifndef __KML_CREATE_H__
#define __KML_CREATE_H__
    ...
    public:
        ...
        xml::Node *asPlacemarks(
            ...
            if (dateStrVec.size() != coorStrVec.size()) {
                std::cerr << "KML-TOOL-> Error. Vector strings of date and coordinate are not in same size\n";
                return nullptr;
            }
