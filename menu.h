...
#define TOTAL_COMMANDS_COUNT 16
...
#define KML_DATE_BY_FOLDER_FLAG 12
#define KML_FILTER_STRING_FLAG 13
#define KML_REMOVE_PATHS_FLAG 14
#define CSV_CHANGE_SEPARATOR_FLAG 15
