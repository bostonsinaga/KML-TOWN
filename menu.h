...
#define TOTAL_COMMANDS_COUNT 57
...
#define KML_CLASSIFY_CLEAN_NEWFILE_FLAG 33
#define KML_CLASSIFY_CLEAN_OVERWRITE_FLAG 34
#define KML_FILTER_PINICON_NEWFILE_FLAG 35
#define KML_FILTER_PINICON_OVERWRITE_FLAG 36
#define KML_FILTER_PATHCOLOR_NEWFILE_FLAG 37
#define KML_FILTER_PATHCOLOR_OVERWRITE_FLAG 38
#define KML_FILTER_NAME_NEWFILE_FLAG 39
#define KML_FILTER_NAME_OVERWRITE_FLAG 40
#define KML_FILTER_DESCRIPTION_NEWFILE_FLAG 41
#define KML_FILTER_DESCRIPTION_OVERWRITE_FLAG 42
#define KML_FILTER_TEXT_NEWFILE_FLAG 43
#define KML_FILTER_TEXT_OVERWRITE_FLAG 44
#define KML_STYLEPINS_ICON_NEWFILE_FLAG 45
#define KML_STYLEPINS_ICON_OVERWRITE_FLAG 46
#define KML_STYLEPINS_SCALE_NEWFILE_FLAG 47
#define KML_STYLEPINS_SCALE_OVERWRITE_FLAG 48
#define KML_STYLEPATH_COLOR_NEWFILE_FLAG 49
#define KML_STYLEPATH_COLOR_OVERWRITE_FLAG 50
#define KML_STYLEPATH_THICKNESS_NEWFILE_FLAG 51
#define KML_STYLEPATH_THICKNESS_OVERWRITE_FLAG 52
#define KML_STYLEPATH_OPACITY_NEWFILE_FLAG 53
#define KML_STYLEPATH_OPACITY_OVERWRITE_FLAG 54
#define CSV_CHANGE_SEPARATOR_NEWFILE_FLAG 55
#define CSV_CHANGE_SEPARATOR_OVERWRITE_FLAG 56
...
class Menu {
    ...
    private:
        ...
        std::string listStrings[TOTAL_COMMANDS_COUNT][MAX_INPUT_STRINGS_COUNT] = {
            ...
            {"--kml", "--classify", "DATA_STRING", "--out", "DATA_STRING", "--clean", "", "", ""},
            {"--kml", "--classify", "DATA_STRING", "--clean", "", "", "", "", ""},
